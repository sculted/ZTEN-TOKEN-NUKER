...
╰━━━━╯╱╰╯╱╰━━━┻╯╱╰━╯╱╱╰╯╱╰━━━┻╯╰━┻━━━┻╯╱╰━╯
    ...
    def input_loop(self):
        ...
        print(self.display_banner() + f'''
            [{Fore.YELLOW}1{Fore.RESET}] token destroy / flood account with custom servers, and remove dms and friends.
            [{Fore.YELLOW}2{Fore.RESET}] token login  / logs in with using token.
            [{Fore.YELLOW}3{Fore.RESET}] token info  / email, phone number, etc.
            [{Fore.YELLOW}4{Fore.RESET}] exit
            [{Fore.GREEN}5{Fore.RESET}] discord.gg/whD9PVAe
        ''')
        cmd = input('> ')
